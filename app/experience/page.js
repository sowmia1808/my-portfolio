export default function Experience() {
  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      <h2 className="text-4xl font-bold text-center mb-12 text-gray-900 dark:text-gray-100">Professional Experience</h2>

      <div className="relative border-l-2 border-gray-300 dark:border-gray-700 ml-4 sm:ml-8">
        {experiences.map((exp, index) => (
          <div key={index} className="mb-10 ml-6 sm:ml-12 relative">
            {/* Circle */}
            <span className="absolute -left-6 sm:-left-8 top-1 bg-blue-500 w-4 h-4 rounded-full border-2 border-white dark:border-gray-900"></span>

            {/* Content */}
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">{exp.role}</h3>
              ...
              {exp.keyProjects && (
                <>
                  <h4 className="mt-4 font-semibold text-gray-800 dark:text-gray-200">Key Projects:</h4>
